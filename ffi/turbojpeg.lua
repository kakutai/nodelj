...
local libs = ffi_luajit_libs or {
   OSX     = { x64 = "bin/OSX/libturbojpeg.0.2.0.dylib" },
   Windows = { x64 = "bin/windows/turbojpeg.dll" },
   Linux   = { x64 = "bin/Linux/libturbojpeg.so.0.2.0", arm = "bin/Linux/libturbojpeg.so.0.2.0" },
}
