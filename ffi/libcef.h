...
__attribute__((visibility("default"))) XDisplay* cef_get_xdisplay();
...
ERR_INVALID_BUNDLED_EXCHANGES = -505,
...
typedef struct _cef_request_t {
  ...
  cef_string_userfree_t(* get_header_by_name)(
      struct _cef_request_t* self,
      const cef_string_t* name);
  ...
  void(* set_header_by_name)(struct _cef_request_t* self,
                                         const cef_string_t* name,
                                         const cef_string_t* value,
                                         int overwrite);
...
typedef struct _cef_frame_t {
  ...
  struct _cef_urlrequest_t*(* create_urlrequest)(
      struct _cef_frame_t* self,
      struct _cef_request_t* request,
...
typedef struct _cef_request_context_t {
  ...
  void(* clear_http_auth_credentials)(
      struct _cef_request_context_t* self,
      struct _cef_completion_callback_t* callback);
...
typedef struct _cef_browser_host_t {
  ...
  unsigned long(* get_opener_window_handle)(
      struct _cef_browser_host_t* self);
  ...
  void(* send_external_begin_frame)(
      struct _cef_browser_host_t* self);
  ...
  void(* send_touch_event)(struct _cef_browser_host_t* self,
  ...
  void(* set_audio_muted)(struct _cef_browser_host_t* self,
                                      int mute);
  ...
  int(* is_audio_muted)(struct _cef_browser_host_t* self);
} cef_browser_host_t;
...
typedef struct _cef_v8value_t {
  ...
  int(* is_array_buffer)(struct _cef_v8value_t* self);
  ...
  struct _cef_v8array_buffer_release_callback_t*(
      * get_array_buffer_release_callback)(
      struct _cef_v8value_t* self);
  int(* neuter_array_buffer)(struct _cef_v8value_t* self);
...
__attribute__((visibility("default"))) cef_v8value_t* cef_v8value_create_array_buffer(
    void* buffer,
    size_t length,
...
typedef struct _cef_response_t {
  ...
  cef_string_userfree_t(* get_charset)(
      struct _cef_response_t* self);




  void(* set_charset)(struct _cef_response_t* self,
  ...
  void(* set_header_by_name)(struct _cef_response_t* self,
                                         const cef_string_t* name,
                                         const cef_string_t* value,
                                         int overwrite);
  ...
  void(* set_url)(struct _cef_response_t* self,
                              const cef_string_t* url);
} cef_response_t;
...
typedef struct _cef_resource_skip_callback_t {
  ...
  void(* cont)(struct _cef_resource_skip_callback_t* self,
                           int64 bytes_skipped);
...
typedef struct _cef_resource_read_callback_t {
  ...
  cef_base_ref_counted_t base;
  void(* cont)(struct _cef_resource_read_callback_t* self,
                           int bytes_read);
...
typedef struct _cef_resource_handler_t {
  ...
  cef_base_ref_counted_t base;
  int(* open)(struct _cef_resource_handler_t* self,
                          struct _cef_request_t* request,
                          int* handle_request,
  ...
  int(* skip)(struct _cef_resource_handler_t* self,
                          int64 bytes_to_skip,
                          int64* bytes_skipped,
                          struct _cef_resource_skip_callback_t* callback);
  int(* read)(struct _cef_resource_handler_t* self,
                          void* data_out,
                          int bytes_to_read,
                          int* bytes_read,
...
typedef struct _cef_display_handler_t {
  ...
  void(* on_loading_progress_change)(
      struct _cef_display_handler_t* self,
      struct _cef_browser_t* browser,
      double progress);
...
typedef struct _cef_render_handler_t {
  ...
  void(* on_paint)(struct _cef_render_handler_t* self,
                               ...
                               int width,
                               int height);
  void(* on_accelerated_paint)(struct _cef_render_handler_t* self,
                                           struct _cef_browser_t* browser,
                                           cef_paint_element_type_t type,
                                           size_t dirtyRectsCount,
                                           cef_rect_t const* dirtyRects,
  ...
  void(* on_text_selection_changed)(
      struct _cef_render_handler_t* self,
      struct _cef_browser_t* browser,
  ...
  void(* on_virtual_keyboard_requested)(
      struct _cef_render_handler_t* self,
      struct _cef_browser_t* browser,
...
typedef struct _cef_resource_request_handler_t {
  ...
  cef_base_ref_counted_t base;
  struct _cef_cookie_access_filter_t*(* get_cookie_access_filter)(
...
typedef struct _cef_cookie_access_filter_t {
  ...
  cef_base_ref_counted_t base;
  int(* can_send_cookie)(struct _cef_cookie_access_filter_t* self,
                                     struct _cef_browser_t* browser,
                                     struct _cef_frame_t* frame,
                                     struct _cef_request_t* request,
                                     const struct _cef_cookie_t* cookie);
  int(* can_save_cookie)(struct _cef_cookie_access_filter_t* self,
                                     struct _cef_browser_t* browser,
                                     struct _cef_frame_t* frame,
                                     struct _cef_request_t* request,
                                     struct _cef_response_t* response,
