...
-- local t = 0
-- set_timer(1000, function()
--    print "hello1000"
--    t = t + 1
--    return t < 6 and 1000 end)
-- set_timer(2000, function() print "hello2000" end)
-- set_timer(3000, function() print "hello3000" end)
-- set_timer(4000, function() print "hello4000" end)
-- set_timer(5000, function() print "hello5000" end)
-- set_timer(4000, function() print "hello4000" end)
